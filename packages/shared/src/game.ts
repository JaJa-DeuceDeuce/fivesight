 ...
 */
 ...
 export const Phase = typeof PhaseT.infer;
 
 export const StatusT = type("'waiting' | 'active' | 'finished'");
 export const Status = typeof StatusT.infer;
 
 export const ResultT = PlayerT.or("'draw'");
 export type Result = typeof ResultT.infer;